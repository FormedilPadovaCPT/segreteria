...
import { serieVerificabile } from './attestati-verifica.js';
...
/* li legge corsi-attestati.js. `conf` la riassegna solo carica(), qui:
   di là si vede sempre il valore corrente (binding vivo, sola lettura) */
export { conf, TIPI_ATT };
