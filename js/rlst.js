...
${FIRMA_SEGRETERIA}`;
  ...
  scaricaEml({
    to: p.email || '',
    cc,
    oggetto: `Formedil Padova - Area Sicurezza e Salute - Invio comunicazione richiesta di affidamento al servizio RLST - ${siglaProtocollo(prot)}`,
    corpo,
    allegati,
    nomeFile: `risposta-rlst-${slugImpresa(p.ragione_sociale)}.eml`,
  });
}
